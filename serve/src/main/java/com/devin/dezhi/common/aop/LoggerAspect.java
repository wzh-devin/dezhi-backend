package com.devin.dezhi.common.aop;

import com.alibaba.fastjson2.JSON;
import com.devin.dezhi.common.annocation.Logger;
...
public class LoggerAspect {
     ...
     * 切面.
     */
    @Pointcut("execution (* com.devin.dezhi..controller..*.*(..)) || @annotation(com.devin.dezhi.common.annocation.Logger)")
    ...
    private void recordLog(final ProceedingJoinPoint joinPoint, final long execTime, final Object result) {
        ...
        log.info("************************************************************************************************************");
        log.info("【请求时间】===> {}", time);
        log.info("【请求地址】===> {}", getIpAddr(httpServletRequest));
